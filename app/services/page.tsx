...
const services = [
  ...
  },
  {
    ...
    features: [
      "FCL (Full Container Load) & LCL (Less than Container Load) shipments",
      "Air freight & sea freight coordination",
      "Export documentation & compliance",
      "Customs clearance at origin and destination",
      "Freight rate negotiation & booking",
      "Multi-modal transport solutions",
      "Cargo tracking & status updates",
      "Hazardous & special cargo handling",
    ],
    icon: "🚛",
