...
export default function MobileBottomCTA() {
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 md:hidden bg-navy-800 border-t border-navy-600 shadow-2xl">
      <div className="flex items-stretch h-16">
        ...
        <a
          href="https://wa.me/919099904497?text=Hi,%20I%20need%20a%20quote%20for%20logistics%20services."
          target="_blank"
